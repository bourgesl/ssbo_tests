...
/**
 * Simple ellipse rendering test hanging with ssbo optimization (AA On / Off)
 *
 * @test
 * @summary TODO
 * @bug TODO
 */
public class EllipseFillHangAAOnOff {

    private final static int N = 10000;
    
    private final static boolean DO_HANG = true;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < N; i++) {
                ...
                System.out.println("paint["+i+"]: duration= " + (1e-6 * time) + " ms.");
